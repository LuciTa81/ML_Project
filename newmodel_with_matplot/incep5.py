...
print(f"최종 Best Valid Acc: {best_val_acc:.4f} (Epoch {best_epoch})")
...
print(
    f"\n[INFO] Loaded best checkpoint (Epoch {ckpt['epoch']}, Val Acc {ckpt['best_val_acc']:.4f})"
)
